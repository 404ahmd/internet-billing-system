    ...
    <div class="main-panel">
        <div class="content">
            <div class="card-body">
                ...
                <form method="GET" action="{{ route('admin.invoices.search') }}" class="mb-3">
                    <div class="mb-2">
                ...
                <form method="GET" action="{{ route('admin.invoices.search') }}" class="mb-4">
                    <div class="mb-2">
                        <label for="status" class="form-label">Filter berdasarkan status pembayaran</label>
                        <select name="status" id="status" class="form-select">
                            <option value="">-- Semua Status --</option>
                            <option value="paid" {{ request('status') == 'paid' ? 'selected' : '' }}>Lunas</option>
                            <option value="unpaid" {{ request('status') == 'unpaid' ? 'selected' : '' }}>Belum Dibayar
                            </option>
