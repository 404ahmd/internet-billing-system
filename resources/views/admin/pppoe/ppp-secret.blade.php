            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.ppp-secret.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control" name="profile" id="profile">
                                        @foreach ($profiles as $profile)
                                            <option value="{{ $profile->name }}">{{ $profile->name }} {{($profile->rate_limit)}}</option>
                                        @endforeach
                                    </select>
                                        ...
                                        <tbody>
                                            @foreach ($secrets as $index => $secret)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form action="{{route('admin.ppp-secret.remove', $secret->id)}}" method="POST"
