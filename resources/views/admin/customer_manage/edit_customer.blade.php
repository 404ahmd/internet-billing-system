    ...
    <div class="content">
        <div class="card-body">
            ...
            <div class="container">
                ...
                <form action="{{ isset($customer) ? route('admin.customer.update', $customer->id) : route('admin.customers.store') }}" method="POST">
                    @csrf
                    @if(isset($customer))
                        @method('PUT')
                    @endif
                    ...
                    <a href="{{ route('admin.customer.view') }}" class="btn btn-secondary">Cancel</a>
                </form>
            </div>
