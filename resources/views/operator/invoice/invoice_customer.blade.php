...
<div class="main-panel">
    <div class="content">
        <div class="card-body">
            ...
            <form method="GET" action="{{ route('operator.invoices.search') }}">
                ...
                <table class="table table-bordered table-hover shadow-sm" style="min-width:900px">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $invoice->notes }}</td>
                            <td>
                                <a href="{{ route('operator.invoices.edit', $invoice->id) }}"
                                    class="btn btn-sm btn-warning">Edit</a>
                                <form action="{{ route('operator.invoices.delete', $invoice->id) }}" method="POST"
