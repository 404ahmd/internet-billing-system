                ...
                <div class="card-body">
                    <form action="{{ route('operator.ip-pool.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" placeholder="Contoh: pppoe-pool" required>
                        </div>

                        <div class="form-group">
                            <label for="range">Range IP</label>
                            <input type="text" name="range" class="form-control" placeholder="192.168.100.2-192.168.100.254" required>
                        </div>
                                ...
                                <tbody>
                                    @foreach ($ip_pools as $index => $pool)
                                        <tr>
                                            ...
                                            <td>{{ $pool->created_at->format('d-m-Y H:i') }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
