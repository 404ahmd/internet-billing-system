                ...
                <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-header text-white bg-primary">
                            <h5 class="mb-0">Tambah PPP Profile</h5>
                        </div>

                        <div class="card-body">
                            <form action="{{ route('operator.ppp-profile.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="rate_limit" class="form-control" placeholder="512k/512k">
                                </div>
                                        ...
                                        <tbody>
                                            @foreach ($profiles as $index => $profile)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form
                                                            action="{{ route('operator.ppp-profile.remove', $profile->id) }}"
                                                            method="POST"
