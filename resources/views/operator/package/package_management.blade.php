                ...
                <div class="col-md-12">
                    ...
                    <div class="modal-dialog modal-lg modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <form method="POST" action="{{ route('operator.package.store') }}">
                                @csrf
                    ...
                    <table class="table table-bordered table-striped" style="min-width: 900px;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('operator.package.edit', $package->id) }}"
                                        class="btn btn-sm btn-warning">Edit</a>
                                    <form action="{{ route('operator.package.destroy', $package->id) }}" method="POST"
                                        class="d-inline"
